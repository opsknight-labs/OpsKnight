...
// getUserActiveSessions and recordSessionHeartbeat have been retired.
// Only parseUserAgent tests remain; the registry test suite covers
// all session tracking scenarios in tests/lib/session-registry.test.ts.
...
describe('active-sessions: parseUserAgent', () => {
  ...
  it('correctly detects iPad as tablet', () => {
    const ua =
