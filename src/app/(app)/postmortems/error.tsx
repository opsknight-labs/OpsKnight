...
export default function PostmortemsError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error('[Postmortems] Render error', {
  ...
  return (
    <div className="w-full px-4 py-12 flex justify-center">
      <div className="max-w-lg w-full rounded-xl border border-rose-200 bg-rose-50/60 p-6 text-center space-y-4">
        ...
        <div>
          <h2 className="text-lg font-semibold text-slate-900">Postmortems couldn&apos;t load</h2>
