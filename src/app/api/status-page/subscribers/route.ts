...
export async function DELETE(req: NextRequest) {
  try {
    ...
    if (!subscription || subscription.statusPageId !== statusPageId) {
    ...
    // Don't say "successfully" when an exception occurred
    return jsonError('Failed to unsubscribe subscriber', 500);
  }
}
