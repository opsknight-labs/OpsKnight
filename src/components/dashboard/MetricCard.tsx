 ...
 */
const useCountUp = (end: number, duration = 350) => {
  ...
  useEffect(() => {
    ...
    // Skip animation on initial mount so cards show initial values immediately
...
const MetricCard = memo(
  ...
  (prevProps, nextProps) => {
    return (
      ...
      prevProps.rangeLabel === nextProps.rangeLabel &&
      ...
      prevProps.dataState === nextProps.dataState
    );
  }
);
