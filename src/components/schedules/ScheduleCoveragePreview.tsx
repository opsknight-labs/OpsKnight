    ...
    <Card className="overflow-hidden border-border/70 shadow-sm">
      <CardHeader className="border-b bg-muted/20 py-4">
        <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-base">Check future coverage</CardTitle>
              <p className="mt-0.5 text-xs text-muted-foreground">
                Verify the effective escalation owner for any date.
              </p>
            </div>
          </div>
          <input
      ...
      <CardContent className="p-4">
        ...
        <p className="mt-3 flex items-center gap-1.5 text-[11px] text-muted-foreground">
          <ShieldCheck className="h-3.5 w-3.5 text-emerald-600" /> Priority and overrides are
          already applied. Times use {timeZone}.
        </p>
        {myNextShift && (
