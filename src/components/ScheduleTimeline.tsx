...
import { ChevronLeft, ChevronRight, Clock, Users, Shield } from 'lucide-react';
...
export default function ScheduleTimeline({
  ...
  return (
    <div className="flex flex-col">
      {/* Sub-toolbar: Date navigation, Range, 7/14 days toggle, Effective Schedule toggle */}
      ...
      <div className="overflow-x-auto">
        <div style={{ minWidth: daysToShow === 7 ? '700px' : '1000px' }}>
                ...
                return (
                  <div key={layerName} className="relative">
                    ...
                    <div className="px-3 py-2 z-20 relative">
                      <div
                        className={cn(
                          'inline-block px-2.5 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider shadow-xs',
                          color.light,
                          color.text
                        )}
                      >
          ...
          {/* Effective Schedule Row */}
          {showFinalSchedule && finalScheduleBlocks.length > 0 && (
            <div className="mt-2 border-t-2 border-border pt-2">
              <div className="relative">
                {/* Final Schedule Label */}
                <div className="px-3 py-2 z-20 relative">
                  <div className="inline-flex items-center gap-1.5 rounded-lg bg-foreground px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-background shadow-xs">
                    <Shield className="h-3 w-3" />
                    Effective On-Call
                  </div>
                </div>
            ...
            <div className="flex flex-wrap items-center gap-4 border-t bg-muted/20 p-4">
              ...
              {[...layerColorMap.entries()].map(([layer, color]) => (
                <div key={layer} className="flex items-center gap-2">
                  <div className={cn('h-3 w-3 rounded-md bg-gradient-to-r shadow-xs', color.bg)} />
