...
${R} {
  ...
  --status-text: var(--sp-ink, var(--status-text, #111827));
  --status-text-strong: var(--sp-ink-strong, var(--sp-ink, var(--status-text-strong, #0f172a)));
  --status-text-muted: var(--sp-muted, var(--status-text-muted, #6b7280));
  --status-text-subtle: var(--sp-muted-2, var(--status-text-subtle, #94a3b8));
  --status-text-inverse: var(--sp-inverse, var(--status-text-inverse, #ffffff));
  --status-panel-bg: var(--sp-panel-bg, var(--status-panel-bg, #ffffff));
  --status-panel-border: var(--sp-panel-border, var(--status-panel-border, #e2e8f0));
  --status-panel-muted-bg: var(--sp-panel-muted-bg, var(--status-panel-muted-bg, #f8fafc));
  --status-panel-muted-border: var(--sp-panel-muted-border, var(--status-panel-muted-border, #e2e8f0));
