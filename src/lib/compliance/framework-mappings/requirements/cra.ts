...
export const craRequirements: readonly FrameworkRequirement[] = [
  {
    ...
    summary:
      'Products with digital elements must be designed, developed, and produced to ensure an appropriate level of cybersecurity based on risks, including protection of data confidentiality through encryption, protection against unauthorized access, integrity verification, and secure default configurations.',
  ...
  {
    id: 'CRA-ART-14-REPORTING',
    framework: 'CRA',
    reference: 'Article 14',
    title: 'Reporting Obligations on Actively Exploited Vulnerabilities and Severe Incidents',
    summary:
      'Manufacturers must notify designated CSIRTs and ENISA of actively exploited vulnerabilities or severe incidents impacting products with digital elements within statutory notification windows.',
    sourceUrl: 'https://eur-lex.europa.eu/eli/reg/2024/2847/2024-11-20/eng',
