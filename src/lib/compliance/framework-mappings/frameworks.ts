...
export const COMPLIANCE_FRAMEWORK_DEFINITIONS: readonly ComplianceFrameworkDefinition[] = [
  ...
  },
  {
    ...
    version: 'ISO/IEC 27701:2019 (Legacy mapping — withdrawn; superseded by ISO/IEC 27701:2025)',
    jurisdiction: 'International',
    frameworkType: 'STANDARD',
    authoritativeSource: 'ISO',
    sourceUrl: 'https://www.iso.org/standard/71670.html',
    notes:
      'ISO/IEC 27701:2019 (Edition 1) is officially withdrawn and superseded by ISO/IEC 27701:2025 (Edition 2). Clause mappings are preserved as legacy/historical references (clauses 6-7). Migration to Edition 2 is planned once licensed Annex A control tables are formally verified.',
  },
  {
    id: 'DPDP',
    ...
    notes:
      'Indian statutory framework; Sections 7–17 and substantive obligations have staged commencement 18 months post-notification (effective 13 May 2027).',
  },
  {
    id: 'CCPA',
