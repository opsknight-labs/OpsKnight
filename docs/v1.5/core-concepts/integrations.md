...
4. From the newly generated integration card:
   - For **Events API v2**: copy the **Events API Endpoint** (`/api/events`) and unique **Routing Key**, and test with the prefilled `curl` snippet (or use the one-click **Copy cURL** button).
