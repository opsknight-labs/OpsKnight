...
| `/m/incidents`                             | Filter all, Active (`OPEN` + `ACKNOWLEDGED`), or Resolved incidents; acknowledge, snooze, or resolve from list cards                                                                    | List-card status actions are the incident writes supported by the offline queue                              |
...
| `/m/services` and `/m/services/[id]`       | Search/view services, health and Active incidents; create an incident for a service                                                                                                     | Snoozed and Suppressed incidents do not mark a service unhealthy; configuration remains a desktop workflow   |
...
| `/m/teams` and `/m/teams/[id]`             | Search/view teams, members, and Active-incident counts                                                                                                                                  | Team administration remains a desktop workflow                                                               |
