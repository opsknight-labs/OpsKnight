...
| Generic        | AppDynamics, Better Uptime, Bitbucket, Datadog, Dynatrace, Elastic, Google Cloud Monitoring, Honeycomb, Icinga, ManageEngine, Nagios, Pingdom, Splunk Observability, Splunk On-Call, Uptime Kuma, UptimeRobot, and generic webhooks | `X-Signature` or `X-Webhook-Signature` is the hexadecimal HMAC-SHA256 of the raw body, without a `sha256=` prefix. |
...
| ManageEngine                                                     | Critical/Trouble/Attention/Service Down states trigger; ACK/assign/maintenance acknowledges.                                     | Clear (`5`), resolved, or both availability `Up` and health `Clear`.                   | Entity (`$entity`), resource/monitor ID, alarm ID, or device/monitor.   |
