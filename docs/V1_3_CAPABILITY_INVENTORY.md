...
| Administrator operational health center      | Admin, operator             | database capacity, scheduler/jobs, paging, delivery, SLA performance, configuration, version | Complete | `v1.3/administration/health-center.md` | Status, limits, response | 4, 5 |
